...
private Context mContext;
    ...
    public RecyclerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,int ViewType)
    {
        ...
        ViewHolder vh=new ViewHolder(v,_case);
        return vh;
    }
    ...
    public void onBindViewHolder(ViewHolder holder,int position)
    {
        ...
        holder.bindMovieData(movie,holder._case);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        CardView cardView;
        int _case;
        public ViewHolder(View v, int _case)
        {
            super(v);
            this._case=_case;
...
public void bindMovieData(Map<String,?> item, int _case)
{
    if(_case==1)
    {
        Drawable[] layers=new Drawable[2];
        layers[0]= ContextCompat.getDrawable(mContext, (Integer) item.get("image"));
        layers[1]=ContextCompat.getDrawable(mContext, R.drawable.rating_circle);
        final LayerDrawable layerDrawable=new LayerDrawable(layers);
        layerDrawable.setLayerInset(1,100,0,0,150);
