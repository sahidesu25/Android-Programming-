    ...
    private void selectItem(int position)
    {
        switch(position)
        {
            ...
            case 1:
                ...
                break;
            case 2:
                getSupportFragmentManager().beginTransaction().setCustomAnimations(R.animator.
                        slide_in_right,R.animator.slide_out_right)
                        .add(R.id.container, RecyclerViewFragment.newInstance(0)).commit();
                break;
            case 3:
                getSupportFragmentManager().beginTransaction().setCustomAnimations(R.animator.slide_in_top,R.animator.slide_out_left, R.animator.slide_in_bottom, R.animator.slide_out_bottom)
                        .add(R.id.container, GridLayoutFragment.newInstance(1)).commit();
                break;
            case 5:
                getSupportFragmentManager().beginTransaction().setCustomAnimations(R.animator.slide_in_top,R.animator.slide_out_top)
