        ...
        public ViewHolder(View v)
        {
          ...
          /*  selector.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    HashMap<String,Boolean> movieMap = (HashMap<String,Boolean>) mDataSet.get(getPosition());
                    ...
                    HashMap<String,String> namemap=(HashMap<String,String>)mDataSet.get(getPosition());
                    final String name_ = (String) namemap.get("name");
                    Toast.makeText(mContext, "Selected" + name_, Toast.LENGTH_SHORT).show();
...
public void bindMovieData(Map<String,?> item)
{
    ...
    Bitmap bitmap=RecyclerViewFragment.imagecache.get(url);
    if(bitmap!=null)
    {
    ...
    {
        MyDownloadImageAsyncTask task=new MyDownloadImageAsyncTask(image);
   ...
   // selector.setChecked((Boolean) item.get("selection"));
